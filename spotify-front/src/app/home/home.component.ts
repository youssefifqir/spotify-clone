...
import {FavortiteSongCardComponent} from "./favortite-song-card/favortite-song-card.component";
...
export class HomeComponent {
  ...
  constructor() {
    this.isLoading = true;
    effect(() => {
      const allSongsResponse = this.songService.getAllSing();
